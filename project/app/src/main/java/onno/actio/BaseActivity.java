...
import onno.actio.util.LUtils;
import onno.actio.widget.MultiSwipeRefreshLayout;
import onno.actio.widget.ScrimInsetsScrollView;

/**
* Created by Onno on 29.03.2015.
*/
public class BaseActivity extends ActionBarActivity implements MultiSwipeRefreshLayout.CanChildScrollUpCallback {
    ...
    protected static final int NAVDRAWER_ITEM_EXOPLORE = 1;
    ...
    private static final int[] NAVDRAWER_TITLE_RES_ID = new int[]{
            ...
            R.string.navdrawer_item_friends,
    ...
    int mThemedStatusBarColor;
    int mNormalStatusBarColor;
    ...
    public void onCreate(Bundle savedInstanceState, PersistableBundle persistentState) {
        ...
        mThemedStatusBarColor = Color.parseColor("#ff0ab246");
    ...
    private void setupNavDrawer() {
        ...
        mDrawerLayout.setDrawerListener(new DrawerLayout.DrawerListener() {
            ...
            public void onDrawerStateChanged(int newState) {
                onNavDrawerStateChanged(mDrawerLayout != null && mDrawerLayout.isDrawerOpen(Gravity.START),
        ...
        mNavDrawerItems.add(NAVDRAWER_ITEM_EXOPLORE);
        mNavDrawerItems.add(NAVDRAWER_ITEM_MAP);
        mNavDrawerItems.add(NAVDRAWER_ITEM_FRIENDS);
...
//            updateSwipeRefreshProgressBarTop();
    ...
    public static void styleRecentTasksEntry(Activity activity) {
        ...
        int colorPrimary = Color.parseColor("#ff0ab246");
        activity.setTaskDescription(new ActivityManager.TaskDescription(label,
                BitmapFactory.decodeResource(resources, R.mipmap.ic_launcher), colorPrimary));
    }
    ...
    public void onBackPressed() {
        if (mDrawerLayout != null && mDrawerLayout.isDrawerOpen(Gravity.START) && mDrawerLayout != null) {
            mDrawerLayout.closeDrawer(Gravity.START);
        } else {
            super.onBackPressed();
        }
