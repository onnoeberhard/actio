...
public class ActivityStart extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        //If this isn't the first time (user already pressed skip on Login-Screen), goto Login-Screen
        if(new LocalDatabaseHandler(this, true).getStuffValue("lr_skipped").equals("true"))
        	gotop3(null);
	}
    ...
    /**
     * Goto Page 2, happens onClick on Page 1
     * @param v
     */
    ...
    /**
     * Page 2, Details What you can do with Actio, all xml
     */
    ...
    /**
     * Goto Page 3, happens onClick on Page 2
     * Also for directly going to Login-Screen from onCreate
     * @param v
     */
     ...
     * Saves in ODB with Username, Password, Date/Time of creation - then saves in LDB -> User is logged in
     * @param v
     */
     ...
     * Saves in LDB -> User is logged in
     * @param v
     */
    ...
    /**
     * Will send an SMS to the phone number linked to the account with a new password.
     * Opend by onClick-> forgot password
     * @param v
     */
     ...
     * Saved in LDB w/ checked? "don't show again"
     * @param v
     */
